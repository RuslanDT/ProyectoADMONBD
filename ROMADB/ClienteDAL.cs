...
namespace ROMADB
{
    public class ClientesDAL
    {
        public bool insertar_en_inventario(cl_inventario item)
        {
            ...
            try
            {
                string insert = "insert into Inventario(nombre_corto, descripcion, serie, color, fecha_adquisicion, tipo_adquisicion,observaciones, id_areas) values(@nombre,@descripcion,@serie,@color,@fecha,@tipo,@obsercaciones,@ID_areas);";
